      ...
      <main>
        ...
        <section className="bg-gray-50 border-b border-gray-200 py-16">
          <div className="max-w-[1200px] mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">BF인증 개요</h2>
            <div className="text-[13px] text-gray-500 flex justify-center gap-2">
              <span>Home</span>
              <span className="text-gray-300">&gt;</span>
              <span>장애물 없는 생활환경 인증</span>
              <span className="text-gray-300">&gt;</span>
              <span className="font-bold text-[#317F81]">인증 개요</span>
            </div>
          </div>
        </section>
        ...
        <section className="py-20">
          <div className="max-w-[1000px] mx-auto px-4">
            ...
            <div className="mb-20">
              ...
              <div className="bg-[#f8fcfc] p-8 rounded-2xl border border-[#e6f2f2] leading-relaxed text-gray-700 break-keep">
                <p className="mb-4">
            ...
            <div className="mb-20">
              ...
              <div className="overflow-x-auto shadow-sm border border-gray-200 rounded-lg">
                <table className="w-full text-left">
                  <thead className="bg-gray-50 border-b border-gray-200 text-sm font-bold">
                    <tr>
                  ...
                  <tbody className="text-[15px] divide-y divide-gray-200">
                    <tr>
                      <td className="px-6 py-5 bg-gray-50 font-semibold border-r border-gray-200">신청시기</td>
                      <td className="px-6 py-5 border-r border-gray-200">설계도면이 완성된 후 공사착공 전</td>
                      <td className="px-6 py-5">공사 준공(사용승인) 전</td>
                    </tr>
                    <tr>
                      <td className="px-6 py-5 bg-gray-50 font-semibold border-r border-gray-200">인증대상</td>
                      <td className="px-6 py-5 border-r border-gray-200">설계도서(도면, 시방서 등)</td>
                      <td className="px-6 py-5">완공된 건축물 및 시설물</td>
                    </tr>
                    <tr>
                      <td className="px-6 py-5 bg-gray-50 font-semibold border-r border-gray-200">유효기간</td>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  { grade: "최우수", score: "만점의 90% 이상", color: "border-blue-500 text-blue-600 bg-blue-50" },
                  { grade: "우수", score: "만점의 80% 이상 90% 미만", color: "border-[#317F81] text-[#317F81] bg-[#f0f9f9]" },
                  { grade: "일반", score: "만점의 70% 이상 80% 미만", color: "border-gray-400 text-gray-600 bg-gray-50" },
                ].map((item, idx) => (
