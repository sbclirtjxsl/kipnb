      ...
      <main>
        ...
        <section className="bg-gray-50 border-b border-gray-200 py-16">
          <div className="max-w-[1200px] mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">인증절차</h2>
            <div className="text-[13px] text-gray-500 flex justify-center gap-2">
              <span>Home</span>
              <span className="text-gray-300">&gt;</span>
              <span>장애물 없는 생활환경 인증</span>
              <span className="text-gray-300">&gt;</span>
              <span className="font-bold text-[#317F81]">인증절차</span>
            </div>
          </div>
        </section>
        ...
        <section className="py-20">
          <div className="max-w-[1000px] mx-auto px-4">
            ...
            <div className="text-center mb-16">
              <h3 className="text-2xl font-bold mb-4 italic text-[#317F81]">"신속하고 정확한 인증 서비스를 약속드립니다."</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-8 relative z-10">
                {steps.map((step, idx) => (
                  <div key={idx} className="flex flex-col items-center group">
                    {/* 원형 번호/아이콘 */}
                    <div className="w-20 h-20 bg-white border-2 border-gray-100 rounded-full flex items-center justify-center text-3xl mb-6 shadow-sm group-hover:border-[#317F81] group-hover:shadow-md transition-all duration-300 relative bg-white">
