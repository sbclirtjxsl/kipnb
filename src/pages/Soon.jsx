    ...
    <div className="min-h-screen bg-white font-sans text-gray-800 flex flex-col">
      ...
      <main className="flex-grow flex items-center justify-center bg-gray-50 py-20">
        <div className="max-w-[600px] w-full mx-auto px-4 text-center">
          ...
          <div className="space-y-2 mb-12 text-lg text-gray-500 break-keep leading-relaxed">
            <p>방문해 주셔서 감사합니다.</p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center font-bold">
            <button 
              ...
              className="px-8 py-3 border border-gray-300 text-gray-600 rounded-md hover:bg-gray-100 transition-colors"
            >
              이전으로
            </button>
            <button 
              onClick={() => navigate('/')} // 홈으로 이동
              className="px-8 py-3 bg-[#317F81] text-white rounded-md hover:bg-[#256062] transition-all shadow-md"
            >
              홈으로 가기
            </button>
          </div>
          ...
          <div className="mt-16 pt-8 border-t border-gray-200">
            <p className="text-sm text-gray-400">
              관련 문의사항은 <span className="text-[#317F81] font-medium">041-900-4980</span>으로 연락 주시기 바랍니다.
            </p>
          </div>
        </div>
      </main>
